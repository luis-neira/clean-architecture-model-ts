...
import { GetOrdersController } from '../../../../../../adapters/controllers/management';
import { PurchaseOrdersRepositoryFactory } from '../../../../../database/repositories';
...
export default class GetOrdersDeliverer extends Deliverer {
  ...
  public async IndexActionJSON(): Promise<void> {
    const ordersRepositoryFactory = new PurchaseOrdersRepositoryFactory();
